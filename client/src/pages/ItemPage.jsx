...
export default function ItemPage() {
  ...
  const isOwner = user?.isAdmin || item?.createdBy?.id === user?.id;
  const readOnly = !isNew && (!writeAccess || !isOwner);
      ...
      <div className="card">
        <div className="card-body">
          ...
          <div className="mb-3">
            ...
            <input className="form-control" value={form.customId} disabled={readOnly}
              ...
              placeholder={isNew ? t('willBeAutoGenerated') : ''} />
          </div>
        ...
        {!readOnly && (
          <div className="card-footer d-flex gap-2">
            ...
            {!isNew && (user?.isAdmin || item?.createdBy?.id === user?.id) && (
            <button className="btn btn-outline-danger ms-auto" onClick={handleDelete}>{t('deleteItem')}</button>
          )}
          </div>
        )}
      </div>
